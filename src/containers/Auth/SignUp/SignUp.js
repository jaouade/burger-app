...
import {Button, Container, Form, Grid, Icon, Message, TableHeader} from "semantic-ui-react";
...
class SignUp extends Component {
    ...
    render() {
        return (
            <Container>
                        ...
                        <Message size={'large'} attached success>
                            <Icon name='info circle'/>
                            Please Create an account in order to use our app.
                        </Message>

                    <Form className={'attached fluid segment'} error={isNotNull(this.props.error)} loading={this.props.loading} onSubmit={this.handleAuth}>
                        ...
                        />
                        <Button color={'green'} disabled={!this.allInputsValid()}
                                type='submit'>SIGN UP</Button>

                    </Form>
                <Message attached='bottom' info>
                    <Icon name='help'/>
                    Already signed up? <MyButton btntype={'Danger'} clicked={this.toggleSignInHandler}>SIGN
                    IN HERE instead.</MyButton>
                </Message>
            </Container>
    ...
    handleAuth = (e) => {
        e.preventDefault()
        this.props.onSignUp(this.state.form.email.value, this.state.form.password.value)
    }
}
